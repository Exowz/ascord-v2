...
export const Header = () => {
  const words = ["reimagined", "better", "beautiful", "modern"];
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
        Ascord <br /> Your workspace, <FlipWords words={words} />
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
      Inspired by the dynamic conversations of Discord and the organization of Asana, Ascord combines the best of both worlds to keep you on track, connected, and productive.
      </p>
